...
class Hittable {
 public:
  ...
  __device__ virtual float pdf_from(const Point3& o, const Vec3& v, curandState *local_rand_state) const {
    return 0.0;
  }
  __device__ virtual Vec3 sample_from(const Vec3& o, curandState *local_rand_state) const {
    return Vec3{1, 0, 0};
  }
  AABB bbox_;
